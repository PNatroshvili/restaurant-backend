...
let SeedService = SeedService_1 = class SeedService {
    ...
    constructor(usersRepo, restaurantsRepo, cuisinesRepo, photosRepo, hoursRepo, catRepo, itemRepo, reviewsRepo) {
    ...
    async run() {
        ...
        for (const c of cuisineData) {
            ...
            if (!cuisine)
                cuisine = await this.cuisinesRepo.save(this.cuisinesRepo.create(c));
        ...
        for (const rd of restaurantData) {
            ...
            for (let ci = 0; ci < menuData.length; ci++) {
                ...
                await this.itemRepo.save(catDef.items.map(item => this.itemRepo.create({ categoryId: cat.id, name: item.name, description: item.desc, price: item.price, isAvailable: true })));
            }
...
exports.SeedService = SeedService = SeedService_1 = __decorate([
    ...
    __param(2, (0, typeorm_1.InjectRepository)(cuisine_entity_1.Cuisine)),
    ...
    __param(5, (0, typeorm_1.InjectRepository)(menu_category_entity_1.MenuCategory)),
    __param(6, (0, typeorm_1.InjectRepository)(menu_item_entity_1.MenuItem)),
    __param(7, (0, typeorm_1.InjectRepository)(review_entity_1.Review)),
